...
class Menus:
    ...
    main_menu = [
        MenuElem('Основное', sub_elems=(
            MenuElem('На главную', 'homepage:home'),
            MenuElem('Пользователи', 'users:user_list'),
            MenuElem('О проекте', 'about:about'),
        )),
        MenuElem('Список товаров', 'catalog:item_list'),

        MenuElem('Обратная связь', 'feedback:feedback', [UserGroup.Auth]),
        ...
        MenuElem('Авторизация', can_see=[UserGroup.NotAuth], sub_elems=(
            MenuElem('Зарегистрироваться', 'users:register'),
            MenuElem('Войти', 'users:login'),
        )),
    ]
